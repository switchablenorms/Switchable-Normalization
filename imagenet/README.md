# Switchable Normalization In Image Classification
...
In evaluation, download the above models and put them into the `{repo_root}/imagenet/data/pretrained_model`.
